...
class CommentHistory(models.Model):
    ...
    comment_fk = models.ForeignKey(Comment, verbose_name=_("original comment"))
    ...
    def get_absolute_url(self):
        return reverse('history:detail', kwargs={'pk': str(self.id), })
    ...
    def create_maybe(cls, comment):
        exists = cls.objects.filter(comment_fk=comment).exists()
